    ...
    <tr>        	
        <td style='width: 75%;'>
            <fieldset style='padding:2%'>
                <div class='album_fecha_view'><?php echo date('d-m-Y',strtotime($album['Album']['fecha'])); ?></div>
                <div class='album_titulo_view'><?php echo $album['Album']['titulo']; ?></div>
                <div class='album_descripcion'><?php echo $album['Album']['descripcion']; ?></div>
                <br/><br/>
                <table class="tabla_imagenes">
                    <tr>
                        <td class="album_imagenes_fondo">
                            <?php
                ...
                <div class='album'>
                    <div class='album_link'><?php echo $this->Html->link('Volver', array('action' => 'index')); ?></div>
                </div>
