            ...
            <div>
                <fieldset  style='padding:3%;'><legend><h3>Enviar Producto</h3></legend>
                    ...
                    <div>
                        <fieldset>               
                            <?php
                            echo $this->Form->create('Producto', array('action' => 'send', 'id' => 'form_send', 'onsubmit' => 'return verificar_checkbox_vacio();'));
                            echo $this->Form->hidden('id_producto', array('value' => $producto['Producto']['id']));
                            ?>
