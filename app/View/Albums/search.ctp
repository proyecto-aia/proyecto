		...
		if ($buscar==1) { 
    		...
    		foreach($albums_encontrados as $i) {
    			$cells = array(
                    ...
                    $this->Html->link($this->Html->image('../img/icons/Magnifier.png'), array('action' => 'view', $i['Album']['id']), array( 'class' => 'button1', 'title' => 'Ver')),
                    $this->Html->link($this->Html->image('../img/icons/Pencil.png'), array('action' => 'edit', $i['Album']['id']), array( 'class' => 'button1', 'title' => 'Editar')),
    				date('d-m-Y',strtotime($i['Album']['fecha'])),
    				$i['Album']['titulo'],
    				$i['Album']['status'],
                    $this->Html->link($this->Html->image('../img/icons/Pictures.png'), array('controller' => 'images', 'action' => 'index', 'Album', $i['Album']['id']), array( 'class' => 'button1', 'title' => 'Imagenes')),
                    $this->Html->link($this->Html->image('../img/icons/Email.png'), array('action' => 'pre_send', $i['Album']['id']), array( 'class' => 'button1', 'title' => 'Enviar')),
    			);
