                ...
                <fieldset>
                    ...
                    foreach ($publicidades as $publicidad) {
                        ...
                        <div class="thumb_img">
                            ...
                            echo $this->Html->link(
                                    $this->Html->image('thumbnails/' . $publicidad['Publicidade']['location'], array('alt' => $publicidad['Publicidade']['name'])), '/img/medium/' . $publicidad['Publicidade']['location'], array('class' => 'grouped', 'rel' => 'group', 'escape' => false)
                            );
                            ?>    							
                            <div style="padding-top: 5px;">
                                <?php
                                //echo $this->Html->link(__('Ver', true), array('action' => 'view', $publicidad['Publicidade']['id']), array('class' => 'thumb_img_action'));
                                echo $this->Html->image('../img/icons/Magnifier.png', array('url' => array('action' => 'view', $publicidad['Publicidade']['id']), 'class' => 'button1', 'title' => 'Ver'));
                                ?>
                                <!--
                                                        &nbsp;
                                <?php
                                ...
                                echo $this->Html->image('../img/icons/Cross.png', array('url' => array('action' => 'delete', $publicidad['Publicidade']['id']), 'class' => 'button1', 'id' => 'eliminar' . $i, 'onclick' => 'return confirmar_eliminar(eliminar' . $i . ');', 'title' => 'Eliminar'));
                                ?>
                            </div>			
                        </div>
