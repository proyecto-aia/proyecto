...
<table class='tabla_normal'>
	<tr>
		<td>
			<div style='width:40%;'>
				<fieldset style='padding:3%;'><legend><h3>Agregar nuevo Usuario</h3></legend>
	<?php
	echo $this->Form->create('User', array('id' => 'agregar'));
	echo $this->Form->input('username', array('label' => 'Usuario*', 'class' => 'required alphanumeric', 'minlength' => '4', 'id' => 'username'));
	echo $this->Form->input('clear_password', array('type' => 'password', 'label' => 'Contrase&ntilde;a', 'class' => 'required', 'minLength' => '6', 'id' => 'clear_password'));
	echo $this->Form->input('confirm_password', array('type' => 'password', 'label' => 'Confirmar Contrase&ntilde;a', 'class' => 'required', 'minLength' => '6', 'id' => 'confirm_password'));
	...
	echo $this->Form->input('status', array('options' => array('Activo' => 'Activo', 'Inactivo' => 'Inactivo'), 'label' => 'Estado', 'selected' => 'Activo', 'id' => 'status'));
	?>
