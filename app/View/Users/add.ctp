...
<table class='tabla_normal'>
	...
	<?php
	echo $form->create('User', array('id' => 'agregar'));
	echo $form->input('username', array('label' => 'Usuario*', 'class' => 'required alphanumeric', 'minlength' => '4', 'id' => 'username'));
	echo $form->input('clear_password', array('type' => 'password', 'label' => 'Contrase&ntilde;a', 'class' => 'required', 'minLength' => '6', 'id' => 'clear_password'));
	echo $form->input('confirm_password', array('type' => 'password', 'label' => 'Confirmar Contrase&ntilde;a', 'class' => 'required', 'minLength' => '6', 'id' => 'confirm_password'));
	...
	echo $form->input('status', array('options' => array('Activo' => 'Activo', 'Inactivo' => 'Inactivo'), 'label' => 'Estado', 'selected' => 'Activo', 'id' => 'status'));
	?>
