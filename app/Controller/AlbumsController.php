        ...
        if (($this->Auth->user('role_id') == 2) && ($this->Auth->user('status') == 'Activo')) {
            ...
            if ($permiso) {
                ...
                if ($buscar == 1) {
                    ...
                    if (($this->request->data['Album']['fecha_ini'] != "") AND ( $this->request->data['Album']['fecha_fin'] != "")) {

                        $fecha_ini =  date('Y-m-d', strtotime($this->data['Album']['fecha_ini']));
                        $fecha_fin =  date('Y-m-d', strtotime($this->data['Album']['fecha_fin']));
                     ...
                     /*ambas vacias*/
                    } else if (($this->request->data['Album']['fecha_ini'] == "") AND ($this->request->data['Album']['fecha_fin'] == ""))
                     {
        ...
        if (($this->Auth->user('role_id') == 2) && ($this->Auth->user('status') == 'Activo')) {
            ...
            if ($permiso) {
                ...
                if (!empty($this->request->data)) {
                    ...
                    if($this->request->data['Album']['fecha'] == ''){
                        $this->request->data['Album']['fecha'] =  date("Y-m-d");
                    }
                    else{
                        /*Para girar la fecha */
                        $this->request->data['Album']['fecha'] = date('Y-m-d', strtotime($this->data['Album']['fecha']));
                    }
