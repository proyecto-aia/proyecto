	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
                ...
                //loading : "<span class=\"alertify-loading\"></span>"
			},
		...
		_alertify = {
			...
			build : function (item) {
                ...
                if (type != "loading") html += dialogs.buttons.holder;
                if (type === "loading") html += dialogs.loading;
		...
		return {
			loading   : function (message, fn) { _alertify.dialog(message, "loading", fn); return this; },		  
