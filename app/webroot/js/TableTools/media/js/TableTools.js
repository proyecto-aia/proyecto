...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabla copiada</h6>'+
				'<p>Se copi&oacute; '+len+' registro'+plural+' al portapapeles.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista Previa de Impresi&oacute;n</h6><p>Por favor utilice la funcion imprimir de su navegador para "+
		  "imprimir &eacute;sta tabla."+ "Presione la tecla ESC cuando termine.",
		"sMessage": null,
		"bShowAll": true,
